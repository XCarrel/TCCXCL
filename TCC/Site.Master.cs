...
namespace TCC
{
    public partial class SiteMaster : MasterPage
    {
        ...
        protected string getVersion()
            // returns the fully qualified version (version + site manager)
        {
            string res = System.Configuration.ConfigurationManager.AppSettings["master"];

            return string.Format("<i>v. {0} ({1})</i>", Global.appversion, res);
        }
    }
}